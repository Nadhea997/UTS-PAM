...
while (True):
    ...
    print(
        f"Health robotmu ({robotmu.nama} - {robotmu.health} HP), health robot lawan ({robot_lawan.nama} - {robot_lawan.health} HP)")
    ...
    if robotmu.health <= 0 or robot_lawan.health <= 0:
        ...
        if robotmu.health > robot_lawan.health:
            ...
            print(
                f"Pemenang di pertandingan robot Yamako adalah robotmu ({robotmu.nama})")
        else:
            print(f"Robotmu ({robotmu.nama}) death - 0 HP")
            print(
                f"Pemenang di pertandingan robot Yamako adalah robot lawan ({robot_lawan.nama})")
        break
